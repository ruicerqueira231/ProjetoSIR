...
<head>
    ...
    <title>Old Password Incorrect</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 text-center mt-5">
                <div class="alert alert-danger" role="alert">
                    <h4 class="alert-heading">Old Password Incorrect!</h4>
                    <p>The old password you entered does not match our records. Please try again.</p>
                    <hr>
