    ...
    if (isset($_POST['uploadImage']) && isset($_FILES['imageUpload'])) {
        ...
        if ($_FILES['imageUpload']['error'] === UPLOAD_ERR_OK) {
            ...
            if (move_uploaded_file($fileTmpName, $uploadPath)) {
                ...
                $updateImageQuery = "UPDATE tb_user SET image_url = ? WHERE id_user = ?";
            ...
            error_log("Upload error code: " . $_FILES['imageUpload']['error']);
        }
    }
}
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-warning">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        ...
                        <ul class="navbar-nav me-auto align-items-center">
                            <li class="nav-item">
                                <img src="<?php echo htmlspecialchars($image_url); ?>" alt="User Image"
                                    class="profile-picture" data-bs-toggle="modal" data-bs-target="#imageModal">
                            </li>
                            <li class="nav-item">
                                <p class="user-name">
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <button class="btn btn-custom me-2" href="dashboard.php">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
                        <div class="mb-3 modal-option">
                            <label for="imageUpload" class="form-label">Profile Image Update</label>
                ...
                <div class="modal-body">
                    <?php foreach ($invitations as $invitation): ?>
                        <div class="card mb-3" id="invite-<?php echo $invitation['id_invite']; ?>">
                            <div class="card-body">
                                <h5 class="card-title">Invitation from User ID:
                                    <?php echo htmlspecialchars($invitation['id_user']); ?>
                                </h5>
                                <p>For Event ID:
                                    <?php echo htmlspecialchars($invitation['id_event']); ?>
                                </p>
